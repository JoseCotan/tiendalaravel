<x-app-layout>
    <div class="w-1/2 mx-auto">
        <form method="POST"
            ...
            <div class="mt-4">
                <x-input-label for="cantidad" :value="'Cantidad del artículo'" />
                <x-text-input id="cantidad" class="block mt-1 w-full"
                    type="text" name="cantidad" :value="old('cantidad', $articulo->cantidad)" required
                    autofocus autocomplete="cantidad" />
