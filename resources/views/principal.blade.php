        ...
        @if (!$carrito->vacio())
            <aside class="flex flex-col items-center w-1/3" aria-label="Sidebar">
                        ...
                        <tbody>
                            @foreach ($carrito->getLineas() as $id => $linea)
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6 text-center">
                                        <a href="{{ route('carrito.eliminar', $articulo) }}" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Eliminar</a>
                                    </td>
                                    <td class="py-4 px-6 text-center">
                                        <a href="{{ route('carrito.aumentar', $articulo) }}" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Aumentar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div>
                    ...
                    <a href="#" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900">Comprar</a>
                </div>
            </aside>
        @endif
    </div>
